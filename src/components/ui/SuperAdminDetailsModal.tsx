      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center space-x-4">
          <div className="flex-shrink-0">
            ...
            <div className={`h-20 w-20 rounded-full bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center border-4 border-primary-100 ${superAdmin.profile_pic_url ? 'hidden' : ''}`}>
          ...
          <div className="flex-1">
            <h2 className="text-2xl font-bold text-gray-900 mb-1">{superAdmin.name}</h2>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <div>
                  ...
                  <p className="font-medium text-gray-900">{superAdmin.first_name}</p>
                </div>
                <div>
                  <span className="text-gray-500">Last Name:</span>
                  <p className="font-medium text-gray-900">{superAdmin.last_name}</p>
                </div>
                <div>
                  <span className="text-gray-500">Username:</span>
                  <p className="font-medium text-gray-900">{superAdmin.username}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900">{formatDate(superAdmin.created_at)}</p>
                </div>
                <div>
                  <span className="text-gray-500">Last Updated:</span>
                  <p className="font-medium text-gray-900">{formatDate(superAdmin.updated_at)}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <div>
                  ...
                  <p className="font-medium text-gray-900 break-all">{superAdmin.email}</p>
                </div>
                <div>
            ...
            {superAdmin.bio && (
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-900">{superAdmin.bio}</p>
              </div>
            )}
